...
public class ImagesBannerWidget extends AppWidgetProvider {
    ...
    public static final String TOAST_ACTION = "com.khrisna.cataloguemovie.TOAST_ACTION";
    public static final String EXTRA_ITEM = "com.khrisna.cataloguemovie.EXTRA_ITEM";
